...
public class calculadora extends javax.swing.JFrame {
    ...
    private void btnPorcentagemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPorcentagemActionPerformed
        ...
        double valorAtual = Double.parseDouble(textoAtual);
            double resultadoPercentual;

            if (operacao.equals("soma") || operacao.equals("subtracao") ||
                operacao.equals("multiplicacao") || operacao.equals("divisao")) {
                // percentual em relação a valor1
                resultadoPercentual = (valor1 * valorAtual) / 100;
                txtResultado.setText(String.valueOf(resultadoPercentual));
            } else {
                // só divide por 100
                resultadoPercentual = valorAtual / 100;
                txtResultado.setText(String.valueOf(resultadoPercentual));
            }
    ...
    private void btnResultadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResultadoActionPerformed
        ...
        if (operacao.equals("soma")) {
            ...
            resultado = valor1 * valor2;
            labelResultado.setText(valor1 + " x " + valor2 + " =");
            txtResultado.setText(String.valueOf(resultado));
            ...
            if (valor2 != 0) {
                ...
                labelResultado.setText("erro: divisao por zero");
                txtResultado.setText("");
            }
    ...
    private void btnFracaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFracaoActionPerformed
        ...
        double valor = Double.parseDouble(textoAtual);
            if (valor != 0) {
                ...
                labelResultado.setText("1 / " + valor + " =");
                txtResultado.setText(String.valueOf(resultado));
            } else {
    ...
    private void btnRaizActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRaizActionPerformed
        ...
        double valor = Double.parseDouble(textoAtual);
            if (valor >= 0) {
                ...
                labelResultado.setText("Erro: raiz de número negativo");
                txtResultado.setText("");
            }
    ...
    private void btnApagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApagarActionPerformed
        String textoAtual = txtResultado.getText();
        if (!textoAtual.isEmpty()) {
            txtResultado.setText(textoAtual.substring(0, textoAtual.length() - 1));
        }
